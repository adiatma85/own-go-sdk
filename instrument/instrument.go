...
type Interface interface {
	...
	MySQLQueryTimer(queryname string) *prometheus.Timer
	// Scheduler Metrics
...
func (i *instrument) MySQLQueryTimer(queryname string) *prometheus.Timer {
	return prometheus.NewTimer(dbQueryDuration.WithLabelValues("mysql", queryname))
}
