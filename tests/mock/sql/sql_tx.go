...
func (m *MockCommandTx) Exec(name, query string, args ...interface{}) (sql.Result, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{name, query}
	for _, a := range args {
...
func (mr *MockCommandTxMockRecorder) Exec(name, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name, query}, args...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Exec", reflect.TypeOf((*MockCommandTx)(nil).Exec), varargs...)
}

// Get mocks base method.
func (m *MockCommandTx) Get(name, query string, dest interface{}, args ...interface{}) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{name, query, dest}
	for _, a := range args {
		varargs = append(varargs, a)
	}
...
func (mr *MockCommandTxMockRecorder) Get(name, query, dest interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name, query, dest}, args...)
...
func (m *MockCommandTx) NamedExec(name, query string, args interface{}) (sql.Result, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommandTxMockRecorder) NamedExec(name, query, args interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCommandTxMockRecorder) Prepare(name, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Prepare", reflect.TypeOf((*MockCommandTx)(nil).Prepare), name, query)
}

// Query mocks base method.
func (m *MockCommandTx) Query(name, query string, args ...interface{}) (*sqlx.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{name, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandTxMockRecorder) Query(name, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name, query}, args...)
...
func (m *MockCommandTx) QueryRow(name, query string, args ...interface{}) (*sqlx.Row, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{name, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandTxMockRecorder) QueryRow(name, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name, query}, args...)
...
func (mr *MockCommandTxMockRecorder) Rebind(query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCommandTx) Select(name, query string, dest interface{}, args ...interface{}) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{name, query, dest}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandTxMockRecorder) Select(name, query, dest interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name, query, dest}, args...)
...
func (mr *MockCommandTxMockRecorder) Stmt(name, stmt interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
