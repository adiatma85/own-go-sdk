...
func (mr *MockCommandMockRecorder) BeginTx(ctx, name, opts interface{}) *gomock.Call {
...
func (m *MockCommand) Exec(ctx context.Context, name, query string, args ...interface{}) (sql.Result, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, name, query}
	for _, a := range args {
...
func (mr *MockCommandMockRecorder) Exec(ctx, name, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, name, query}, args...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Exec", reflect.TypeOf((*MockCommand)(nil).Exec), varargs...)
}

// Get mocks base method.
func (m *MockCommand) Get(ctx context.Context, name, query string, dest interface{}, args ...interface{}) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, name, query, dest}
	for _, a := range args {
		varargs = append(varargs, a)
	}
...
func (mr *MockCommandMockRecorder) Get(ctx, name, query, dest interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, name, query, dest}, args...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockCommand)(nil).Get), varargs...)
}

// In mocks base method.
func (m *MockCommand) In(query string, args ...interface{}) (string, []interface{}, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommandMockRecorder) In(query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCommand) NamedExec(ctx context.Context, name, query string, args interface{}) (sql.Result, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommandMockRecorder) NamedExec(ctx, name, query, args interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCommand) NamedQuery(ctx context.Context, name, query string, arg interface{}) (*sqlx.Rows, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommandMockRecorder) NamedQuery(ctx, name, query, arg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCommandMockRecorder) Ping(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCommandMockRecorder) Prepare(ctx, name, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Prepare", reflect.TypeOf((*MockCommand)(nil).Prepare), ctx, name, query)
}

// Query mocks base method.
func (m *MockCommand) Query(ctx context.Context, name, query string, args ...interface{}) (*sqlx.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, name, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandMockRecorder) Query(ctx, name, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, name, query}, args...)
...
func (m *MockCommand) QueryIn(ctx context.Context, name, query string, args ...interface{}) (*sqlx.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, name, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandMockRecorder) QueryIn(ctx, name, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, name, query}, args...)
...
func (m *MockCommand) QueryRow(ctx context.Context, name, query string, args ...interface{}) (*sqlx.Row, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, name, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandMockRecorder) QueryRow(ctx, name, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, name, query}, args...)
...
func (mr *MockCommandMockRecorder) Rebind(query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
