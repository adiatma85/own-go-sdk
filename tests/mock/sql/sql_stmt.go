...
func (m *MockCommandStmt) Exec(name string, args ...interface{}) (sql.Result, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommandStmtMockRecorder) Exec(name interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCommandStmt) Get(name string, dest interface{}, args ...interface{}) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{name, dest}
	for _, a := range args {
		varargs = append(varargs, a)
	}
...
func (mr *MockCommandStmtMockRecorder) Get(name, dest interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name, dest}, args...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockCommandStmt)(nil).Get), varargs...)
}

// Query mocks base method.
func (m *MockCommandStmt) Query(name string, args ...interface{}) (*sqlx.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{name}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandStmtMockRecorder) Query(name interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name}, args...)
...
func (m *MockCommandStmt) QueryRow(name string, args ...interface{}) (*sqlx.Row, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{name}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandStmtMockRecorder) QueryRow(name interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name}, args...)
...
func (m *MockCommandStmt) Select(name string, dest interface{}, args ...interface{}) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{name, dest}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockCommandStmtMockRecorder) Select(name, dest interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{name, dest}, args...)
