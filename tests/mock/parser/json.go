...
func (m *MockJSONInterface) Marshal(orig interface{}) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockJSONInterfaceMockRecorder) Marshal(orig interface{}) *gomock.Call {
...
func (m *MockJSONInterface) MarshalWithSchemaValidation(sch string, orig interface{}) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockJSONInterfaceMockRecorder) MarshalWithSchemaValidation(sch, orig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockJSONInterface) Unmarshal(blob []byte, dest interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockJSONInterfaceMockRecorder) Unmarshal(blob, dest interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockJSONInterface) UnmarshalWithSchemaValidation(sch string, blob []byte, dest interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockJSONInterfaceMockRecorder) UnmarshalWithSchemaValidation(sch, blob, dest interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
