...
const (
	FileUploadBackDateErrorID    = "Mohon akhiri siklus yang sedang berjalan sebelum mengunggah dokumen baru."
	FileUploadWrongFileErrorID   = "Mohon periksa kembali format dan template excel."
	FileUploadForwardDateErrorID = "Mohon periksa kembali tanggal yang ada pada kolom excel untuk tidak melebihi waktu saat ini."
