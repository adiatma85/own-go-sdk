...
func shortFuncName(f *runtime.Func) string {
	...
	// - "github.com/delosaqua/go-sdk/<package>.<FuncName>"
	// - "github.com/delosaqua/go-sdk/<package>.<Receiver>.<MethodName>"
	// - "github.com/delosaqua/go-sdk/<package>.<*PtrReceiver>.<MethodName>"
	longName := f.Name()
